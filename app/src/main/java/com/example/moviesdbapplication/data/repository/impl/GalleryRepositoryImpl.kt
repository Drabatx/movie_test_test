...
import com.example.moviesdbapplication.data.repository.GenericRepository
...
class GalleryRepositoryImpl @Inject constructor(private val storageReference: StorageReference) :
    GalleryRepository, GenericRepository() {

    override fun getAllImagesFromGallery(): LiveData<Result<List<ImageResponse>>> {
